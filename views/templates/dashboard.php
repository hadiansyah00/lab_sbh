...
<head>
	...
	<title><?= $title; ?> | SBH | Inventori</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
			...
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex text-white align-items-center bg-light justify-content-center" href="<?= base_url('dashboard'); ?>">

				<div class="sidebar-brand-icon">

					<i aria-hidden="true"><img src="<?= base_url();
													?>assets/img/logo_sbh2.png" width="80"></i>
				</div>
				<div class="sidebar-brand-text mx-3 img-center"></div>
			</a>
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
			...
			<li class="nav-item">
				...
				<div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan / Jenis</a>
						<a class="collapse-item" href="<?= base_url('jenis'); ?>">Kategori</a>
						<a class="collapse-item" href="<?= base_url('gudang'); ?>">Lokasi / Gudang</a>
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link pb-0" href="<?= base_url('aset'); ?>">
					<i class="fas fa-fw fa-download"></i>
					<span><b>Aset</b></span>
				</a>
			</li>
			...
			<?php if (is_admin()) : ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('user'); ?>">
						...
						<span><b>Data Pengguna / User</b></span>
					</a>
				</li>
			<?php endif; ?>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<!-- Topbar -->
				<nav class="navbar navbar-expand navbar-warning bg-light  topbar mb-4 static-top shadow-sm">
			...
			<footer class="sticky-footer bg-light">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; Stikes Bogor Husada &bull; 2022 &bull; by <?= anchor('sbh.ac.id', 'IT-DIVISION'); ?></span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
