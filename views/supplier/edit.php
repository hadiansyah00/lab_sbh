				...
				<div class="row form-group">
					...
					<div class="col-md-9">
						<div class="input-group">
							...
							<input value="<?= set_value('nama_supplier', $supplier['supplier']); ?>" name="supplier" id="supplier" type="text" class="form-control" placeholder="Supplier...">
						</div>
					...
					<div class="col-md-9">
						...
						if ($supplier['foto'] !== null) { ?>
							<div style="margin-bottom: 10px;">
								<img src="<?= base_url() ?>assets/img/avatar/<?= $supplier['foto']; ?>" width="100px">
							</div>
						<?php } ?>
						<input name="foto" id="foto" type="file" class="input-group">
						<small>(Biarkan Kosong Jika Tidak <?= $supplier['foto'] ? 'Diganti' : 'Ada' ?>)</small>
